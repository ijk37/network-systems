...
<strong>Previous:</strong> [Subnetting Examples](08-07-subnetting-examples.md) &nbsp;|&nbsp; [All Notes](README.md) &nbsp;|&nbsp; [Module 08 Exercise](../02-exercises/08-exercise.md) &nbsp;|&nbsp; <strong>Next:</strong> [Implementing Subnets on a Network](08-09-implementing-subnets.md)

...
<strong>Previous:</strong> [Cloud Deployment Models &amp; Characteristics](07-02-cloud-deployment.md) &nbsp;|&nbsp; [All Notes](README.md) &nbsp;|&nbsp; [Module 07 Exercise](../02-exercises/07-exercise.md) &nbsp;|&nbsp; <strong>Next:</strong> [Remote Access Methods](07-04-remote-access-methods.md)

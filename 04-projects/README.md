...
| Module | Projects |
|--------|----------|
| 01 Introduction | 02, 06, 11 |
| 02 Infrastructure & Documentation | 07, 08 |
| 03 Addressing | 01, 03, 04, 06 |
| 04 Network Protocols | 04, 06, 10 |
| 05 Cabling | 08 |
| 06 Wireless | 09 |
| 07 Cloud & Remote Access | 10 |
| 08 Subnets & VLANs | 01, 02, 05, 09 |
| 09 Risk Management | 05 |
| 10 Security in Network Design | 05, 09 |
| 11 Performance & Recovery | 11 |
| 12 Wide Area Networks | 03, 10 |

---

## Tools

- **Cisco Packet Tracer** (free from Cisco Networking Academy) — projects 01–05, 09–11.
...
4. **09 → 05** — wireless, then bring security together.
5. **06** — anytime, to see protocols on the wire.
